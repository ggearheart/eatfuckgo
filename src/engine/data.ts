...
export const ART: Record<string,string> = {
  ...
  // FK — Sexual Parasitism: anglerfish, glowing lure, tiny male fused to her belly
  sex_parasit:`<svg viewBox="0 0 100 100"><rect width="100" height="100" fill="#08182a"/><circle cx="55" cy="10" r="11" fill="#ffe14a" opacity="0.25"/><path d="M46,32 Q39,15 55,9" fill="none" stroke="#33475a" stroke-width="3"/><circle cx="55" cy="9" r="6" fill="#ffe14a" stroke="#a07000" stroke-width="2"/><path d="M18,58 Q30,34 60,44 Q78,48 90,40 Q82,64 62,64 Q40,74 22,66 Z" fill="#20303e" stroke="#0a1420" stroke-width="3" stroke-linejoin="round"/><path d="M18,58 l-9,-7 3,15 Z" fill="#20303e" stroke="#0a1420" stroke-width="3" stroke-linejoin="round"/><path d="M60,52 Q74,50 87,43" fill="none" stroke="#0a1420" stroke-width="3"/><g fill="#fff" stroke="#0a1420" stroke-width="1"><path d="M65,52 l2,5 2,-5Z"/><path d="M71,51 l2,5 2,-5Z"/><path d="M77,49 l2,5 2,-5Z"/><path d="M83,46 l2,5 2,-5Z"/></g><circle cx="64" cy="46" r="2.6" fill="#bfe8ff" stroke="#0a1420" stroke-width="1"/><path d="M44,64 L44,66" stroke="#0a1420" stroke-width="2"/><ellipse cx="42" cy="72" rx="10" ry="5" fill="#3a4a58" stroke="#0a1420" stroke-width="2"/><path d="M32,72 l-5,-3 1,6 Z" fill="#3a4a58" stroke="#0a1420" stroke-width="2"/><circle cx="37" cy="72" r="1.5" fill="#bfe8ff"/></svg>`,
};
